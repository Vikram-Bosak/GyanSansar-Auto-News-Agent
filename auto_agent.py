...
def job():
    ...
    for item in news_items:
        ...
        # Select a random style from 1 to 15 (Rochak Tathya styles)
        selected_style_id = random.randint(1, 15)
        logging.info(f"Using Image Template Style ID: {selected_style_id}")
